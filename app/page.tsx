  ...
  return (
    <>
      ...
      <section className="bg-paper py-20 lg:py-28">
        <div className="shell reveal grid gap-12 lg:grid-cols-2">
          <div>
            <Pill className="mb-6">About us</Pill>
            <h2 className="text-h2">We are committed to advancing agriculture.</h2>
      ...
      <section className="shell grid gap-12 py-20 sm:grid-cols-3 lg:py-28">
        {stats.map((s) => (
          <div key={s.label} className="reveal">
            ...
            <p className="mt-5 text-[64px] font-medium leading-none tracking-[-2px] lg:text-[72px]">
              {s.value}
            </p>
            <h3 className="mt-5 text-[19px] font-medium">{s.label}</h3>
      ...
      <section className="shell py-20 lg:py-28">
        <div className="reveal grid gap-12 lg:grid-cols-[minmax(0,330px)_minmax(0,1fr)]">
          <div>
            <Pill className="mb-6">Our solutions</Pill>
            <h2 className="text-h2">Innovating the way you grow.</h2>
      ...
      {/* ===== Sustainability ===== */}
      <section className="shell py-20 lg:py-28">
        <div className="reveal grid items-center gap-12 rounded-card bg-paper p-8 sm:p-12 lg:grid-cols-2 lg:p-16">
          <div>
            <h2 className="text-[40px] font-medium leading-[1.08] tracking-[-1.2px] lg:text-[70px] lg:leading-[77px]">
            ...
            <dl className="mt-10">
              {sustainability.map((s) => (
                <div key={s.title} className="border-t border-black/10 py-5">
      ...
      <section className="shell py-20 lg:py-28">
        <div className="reveal flex flex-col items-center text-center">
          ...
          <h2 className="max-w-3xl text-[36px] font-medium leading-[1.1] tracking-[-1.2px] sm:text-[48px] lg:text-[62px] lg:leading-[1.08]">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          {why.map((c) => (
            <article
              key={c.title}
              className={`reveal rounded-card p-8 transition-transform duration-500 lg:hover:rotate-0 ${c.tone} ${c.tilt}`}
            >
